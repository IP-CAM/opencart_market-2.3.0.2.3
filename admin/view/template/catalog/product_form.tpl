            ...
            <div class="tab-pane" id="tab-image">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td colspan="2" class="text-left"><?php echo $entry_image; ?></td>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left">
	                      <label for="product-thumb-name">Название для картинки</label>
	                      <input type="text" value="<?php echo $thumb_name; ?>" name="product_thumb_name" id="product-thumb-name" class="form-control" placeholder="Введите Сео Название для картинки" />
                      </td>
                  </tr>
                  </tbody>
                </table>
                ...
                <table id="images" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <td class="text-right">Название для картинки</td>
                  ...
                  <tbody>
                    ...
                    <tr id="image-row<?php echo $image_row; ?>">
                      <td class="text-left"><a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['image']; ?>" id="input-image<?php echo $image_row; ?>" /></td>
	                    <td class="text-left">
		                    <input type="text" value="<?php echo $product_image['name']; ?>" name="product_image[<?php echo $image_row; ?>][name]" id="product-thumb-name<?php echo $image_row; ?>" class="form-control" placeholder="Введите Сео Название для картинки" />
	                    </td>
...
function addImage() {
	...
	html += '  <td class="text-left"><input type="text" name="product_image[' + image_row + '][name]" id="product-thumb-name' + image_row + '" class="form-control" placeholder="Введите Сео Название для картинки" /></td>';
